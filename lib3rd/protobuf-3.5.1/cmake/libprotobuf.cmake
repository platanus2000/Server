...
add_library(${LIB_PROTOBUF} ${protobuf_SHARED_OR_STATIC}
  ${libprotobuf_lite_files} ${libprotobuf_files} ${libprotobuf_includes})
target_link_libraries(${LIB_PROTOBUF} ${CMAKE_THREAD_LIBS_INIT})

SET(LIBRARY_OUTPUT_PATH ${DIR_PROTOBUF}/lib)
SET_PROPERTY(TARGET ${LIB_PROTOBUF} PROPERTY FOLDER ${LIB_3RD_FOLDER})

if(protobuf_WITH_ZLIB)
    target_link_libraries(${LIB_PROTOBUF} ${ZLIB_LIBRARIES})
endif()
target_include_directories(${LIB_PROTOBUF} PUBLIC ${protobuf_source_dir}/src)
# if(MSVC AND protobuf_BUILD_SHARED_LIBS)
#   target_compile_definitions(${LIB_PROTOBUF}
#     PUBLIC  PROTOBUF_USE_DLLS
#     PRIVATE LIBPROTOBUF_EXPORTS)
# endif()
# set_target_properties(${LIB_PROTOBUF} PROPERTIES
